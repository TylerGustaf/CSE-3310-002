...
// DDS StockMarket::Stock TypeSupportFactory Object Body

::DDS::DataWriter_ptr
StockMarket::StockTypeSupportFactory::create_datawriter (gapi_dataWriter handle)
{
    return new StockMarket::StockDataWriter_impl(handle);
}

::DDS::DataReader_ptr
StockMarket::StockTypeSupportFactory::create_datareader (gapi_dataReader handle)
{
    return new StockMarket::StockDataReader_impl (handle);
}


::DDS::DataReaderView_ptr
StockMarket::StockTypeSupportFactory::create_view (gapi_dataReaderView handle)
{
    return new StockMarket::StockDataReaderView_impl (handle);
}

// DDS StockMarket::Stock TypeSupport Object Body

StockMarket::StockTypeSupport::StockTypeSupport(void) :
    TypeSupport_impl(
        __StockMarket_Stock__name(),
        __StockMarket_Stock__keys(),
        StockMarket::StockTypeSupport::metaDescriptor,
        (gapi_copyIn) __StockMarket_Stock__copyIn,
        (gapi_copyOut) __StockMarket_Stock__copyOut,
        (gapi_readerCopy) ::DDS::ccpp_DataReaderCopy<StockMarket::StockSeq, StockMarket::Stock>,
        new  StockMarket::StockTypeSupportFactory(),
        StockMarket::StockTypeSupport::metaDescriptorArrLength)
{
...
::DDS::ReturnCode_t
StockMarket::StockTypeSupport::register_type(
...
char *
StockMarket::StockTypeSupport::get_type_name() THROW_ORB_EXCEPTIONS
{
...
StockMarket::StockDataWriter_impl::~StockDataWriter_impl(void)
{
    // Parent destructor takes care of everything.
}
...
) : ::DDS::DataReader_impl(handle, ::DDS::ccpp_DataReaderParallelDemarshallingMain<StockMarket::StockSeq>)
{
    // Parent constructor takes care of everything.
}

StockMarket::StockDataReader_impl::~StockDataReader_impl(void)
{
    // Parent destructor takes care of everything.
}
...
StockMarket::StockDataReaderView_impl::~StockDataReaderView_impl(void)
{
    // Parent destructor takes care of everything.
}
...
const char * ::StockMarket::StockTypeSupport::metaDescriptor[] = {"<MetaData version=\"1.0.0\"><Module name=\"StockMarket\"><Struct name=\"Stock\"><Member name=\"ticker\">",
"<String/></Member><Member name=\"price\"><Float/></Member></Struct></Module></MetaData>"};
const ::DDS::ULong (::StockMarket::StockTypeSupport::metaDescriptorArrLength) = 2;
